...
import { useSheetData } from "../context/SheetDataContext"; // Adjust path if necessary
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          ...
          <div className="space-y-4 mb-16 max-w-3xl">
            ...
            <p className="text-gray-500 text-sm md:text-base leading-relaxed">
              Have questions about your global eligibility, admission deadlines,
              or immigration requirements? Drop us a line below or visit our
              corporate headquarters.
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch">
            {/* COLUMN LEFT (5 Cols) - Physical Touchpoints & Contact Card Details */}
                    ...
                    >
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          Our credential validators response timeline is
                          typically under 12 working hours.
                        </p>
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-1.5 text-left">
                          ...
                          <input
                            ...
                            className={`w-full px-4 py-3 bg-slate-50 border rounded-2xl text-xs font-medium focus:bg-white focus:outline-none transition-all duration-200 ${
                              errors.name
                                ? "border-[#f15b24]/50 text-[#f15b24] focus:ring-1 focus:ring-[#f15b24]"
                                : "border-gray-200 focus:border-[#f15b24]"
                            }`}
                          />
                          {errors.name && (
                        ...
                        <div className="space-y-1.5 text-left">
                          <label className="text-[11px] font-mono font-bold uppercase tracking-wider text-gray-650">
                            Email Address{" "}
                            <span className="text-[#f15b24]">*</span>
                          </label>
                          <input
                            type="email"
                            name="email"
                      ...
                      <div className="space-y-1.5 text-left">
                        ...
                        >
                          ...
                          <option value="Admission Screening">
                            Free Academic Document Pre-Check
                          </option>
                          <option value="Scholarship Evaluation">
                            Merit Scholarship Inquiries
                          </option>
                          <option value="Visa Compliance Pack">
                            Immigration & Visa Documentation Pack
                          </option>
                          <option value="Partner Alliance">
                      ...
                      <div className="space-y-1.5 text-left">
                        ...
                        <textarea
                          ...
                          className={`w-full px-4 py-3 bg-slate-50 border rounded-2xl text-xs font-medium focus:bg-white focus:outline-none transition-all duration-200 focus:outline-none resize-none ${
                            errors.message
                              ? "border-[#f15b24]/50 focus:ring-1 focus:ring-[#f15b24]"
                              : "border-gray-200 focus:border-[#f15b24]"
                          }`}
                        />
                        {errors.message && (
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-550 max-w-md mx-auto leading-relaxed">
                          Thank you for connecting. Our lead academic counselor
                          for{" "}
                          <strong className="text-gray-900 bg-orange-50 px-1.5 py-0.5 rounded">
                            {formData.destination || "Australia"}
                          </strong>{" "}
                          has received your background dossier. We will reach
                          back using email & phone.
                        </p>
                      </div>
