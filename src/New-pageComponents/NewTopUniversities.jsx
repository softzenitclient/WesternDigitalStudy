      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="space-y-1">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-[#2c3164] font-serif tracking-tight">
            Partner Universities in New Zealand
          </h2>
          <p className="text-gray-500 text-sm max-w-xl font-sans">
            Acquire degrees certified globally across the complete Commonwealth spectrum of research excellence.
          </p>
        </div>
      </div>
